...
As the main Termux app and packages was not ready for this - and it was not yet clear exactly which changes was necessary to pass the Google Play review process - it was done from a different code base containing changes compared to the F-Droid build:
...
## Updates
- `2022-06-XX` (shortly): The F-Droid build will be updated 
- `2022-06-XX` (shortly): Version `0.122` of Termux on Google Play will be released as soon as it passes Google Play review, fixing some crashes and instabilities, as well as bring full-screen support.
